...
class DefaultController extends Controller {
	...
	public function articulosAction() {
		//-- Simulamos obtener los datos de la base de datos cargando losartículos a un array
		$articulos = array(
		...
		return $this->render('MDWDemoBundle:Default:articulos_todos.html.twig', array('articulos' => $articulos));
	}
	...
	public function articuloAction($id) {
		...
		return $this->render('MDWDemoBundle:Default:articulos_todos.html.twig',array('articulo' => $articuloSeleccionado , 'articulos' => $articulo))
	}
